...
(function () {
  ...
  const zh = {
    ...
    'Prices below are suggested. They help cover ingredients and daily operations. Feel free to pay more to support Ling Cafe, or less if needed.':'所列金额为建议捐赠，用于食材与日常运营。欢迎量力支持，多一点或少一点都可以。',
    'Choose from today’s menu by category. The amount shown is a suggested donation, not a price.':'按分类挑选今日饮品。所列金额为建议捐赠，可量力支持。',
    ...
    'Suggested':'建议捐赠','+ Add':'+ 添加','Not today':'今日暂缺','No items yet.':'尚未添加饮品。','Total suggested':'建议捐赠合计',
